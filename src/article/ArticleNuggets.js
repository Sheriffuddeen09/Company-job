  ...
  const sidecontent = (
    <section className="content sm:block hidden">
      <div className="bg-gray-100 p-6 rounded-lg shadow-md text-gray-800">
        ...
        <button
          onClick={downloadPDF}
          className="flex items-center gap-2 mt-6 px-4 py-2 bg-blue-600 text-white rounded-lg shadow-sm hover:bg-blue-500 transition duration-200"
        >
          <svg
  ...
  const content = (
    <section id="content" className="black sm:mb-20 mb-14 sm:px-4 sm:px-3">
      ...
      <section className='my-5' id="section2 mt-10">
        <p className=' !text-xl mb-3 lg:w-10/12 md:w-96 w-72 articles text-justify'>I'm super excited to be able to share this with you.</p>
        <p className=' !text-xl mb-3 lg:w-10/12 md:w-96 w-72 articles text-justify'>Before we get too busy, let's get some mental boost.</p>
        <p className='!text-xl mb-0 lg:w-10/12 md:w-96 w-72 text-justify articles '>This write-up is divided into five sections for easy consumption. You can take a break after
          each section. </p>

        <p className='!text-xl articles mt-4 sm:mb-7 mb-5 lg:w-10/12 md:w-96 w-72 text-justify'>I know this writeup will take my time, but in times like this, humanity comes first. So test your
          resilience and discipline also by determining to get to the end.</p>
        <p className='!text-xl sm:mb-10 mb-5 lg:w-10/12 md:w-96 w-80 articles'>Let's dive right into it
        </p>
      </section>
      ...
      <section id="section2 mb-30">
        ...
        >
          SECTION 1
          <span className="text-gray-500 font-medium text-lg ml-2">(SPIRITUALITY)</span>
        ...
        <p className='mt-3 mb-7 lg:w-10/12 md:w-96 articles w-72 text-justify'>It’s important to begin by highlighting that Islam encourages planning and foresight. In fact, you
        ...
        <div className=''>
          <p className=' mb-3 text-justify'>Let's do more, we need all of them.
          </p>
          ...
          <section>
            ...
            >
              SECTION 2
              <span className="text-gray-500 font-medium text-lg ml-2">(GENERAL LIFE HACKS)</span>
              <div className="absolute mt-1 bg-blue-500 h-1 w-14 rounded-lg"></div>
            </h2>

            <img src={life} alt="imagesave" className=' my-5 heights w-72 sm:w-10/12 rounded ' />
            <p className=' !text-xl mb-3 lg:w-10/12 md:w-96 w-72 articles text-justify'>
      ...
      <section id="section3">
        ...
        >
          SECTION 3
          <span className="text-gray-500 font-medium text-lg ml-2">(FINANCIAL FREEDOM)</span>
          <div className="absolute mt-1 bg-blue-500 h-1 w-14 rounded-lg"></div>
        </h2>
        ...
        <p className=' !text-xl mb-3 lg:w-10/12 md:w-96 w-72 articles text-justify sm:translate-x-4'>
      ...
      <section id="section4">
        ...
        >
          SECTION 4
          <span className="text-gray-500 font-medium text-lg ml-2">(STAYING HEALTHY)</span>
          <div className="absolute mt-1 bg-blue-500 h-1 w-14 rounded-lg"></div>
        </h2>
      ...
      <section id="section5">
        ...
        >
          SECTION 5
          <span className="text-gray-500 font-medium text-lg ml-2">(FAMILY AND FRIENDS)</span>
          <div className="absolute mt-1 bg-blue-500 h-1 w-14 rounded-lg"></div>
        </h2>
      ...
      <section id="section6">
        <h2
          id="section6"
          className="text-2xl sm:text-3xl font-extrabold text-blue-600 mb-6 mt-10 text-left relative"
        >
          CONCLUSION
          <div className="absolute mt-1 bg-blue-500 h-1 w-14 rounded-lg"></div>
        </h2>
