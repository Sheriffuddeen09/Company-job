...
function ArticleNuggets() {
  ...
  const sidecontent = (
    <section className="content sm:block hidden">
      <div className="bg-gray-100 px-6 py-2 sm:mt-4 rounded-lg shadow-md text-gray-800">
        <p className="space-y-5 mb-2">
          <a
            href="#section1"
            className="text-blue-600 font-semibold hover:underline hover:text-blue-500 transition duration-200 inline-block"
          >
            SECTION 1
            <span className="ml-2 text-sm text-gray-600">(SPIRITUALITY)</span>
          </a>
          ...
          >
            SECTION 2
            <span className="ml-2 text-sm text-gray-600">(GENERAL LIFE HACKS)</span>
          </a>
          <span className="text-gray-400 mx-2">||</span>
          <a
            href="#section3"
          ...
          >
            SECTION 3
            <span className="ml-2 text-sm text-gray-600">(FINANCIAL FREEDOM)</span>
          </a>
        </p>

        <p className="space-y-3 mt-5">
          <a
            href="#section4"
            className="text-blue-600 font-semibold hover:underline hover:text-blue-500 transition duration-200 inline-block"
          >
            SECTION 4
            <span className="ml-2 text-sm text-gray-600">(STAYING HEALTHY)</span>
          </a>
          <span className="text-gray-400 mx-2">||</span>
          <a
            href="#section5"
          ...
          >
            SECTION 5
            <span className="ml-2 text-sm text-gray-600">(FAMILY AND FRIENDS)</span>
          </a>
          <span className="text-gray-400 mx-2">||</span>
          <a
            href="#section6"
        ...
        {/* New section for author name and date */}
        <div className="mt-6">
          <p className="text-sm text-gray-600">
            <span className="font-semibold text-gray-800">Author:</span> Saliu Oladitan
          </p>
          <p className="text-sm text-gray-600">
            <span className="font-semibold text-gray-800">Published:</span> January 5, 2025
          </p>
        </div>
        ...
        <button
          onClick={downloadPDF}
          className="flex items-center gap-2 mt-6 px-4 mb-6 py-2 bg-blue-600 text-white rounded-lg shadow-sm hover:bg-blue-500 transition duration-200"
        >
          <svg
  ...
  const downcontent = (
    <section className="block sm:hidden -mb-5 -mt-2 py-4 sm:p-4 content ">
      <div className=" rounded  " style={{ fontSize: "10px", color:"black" }}>
        <p className='mb-1'>
          ...
          <a href='#section2' className='text-blue-400 font-bold hover:underline hover:text-blue-400 font-bold'> SECTION 2 </a><span style={{ fontSize: '8px', fontWeight: "lighter", color: "black" }}>(GENERAL LIFE HACKS)ers</span> </p>
          <p className="mb-1"> <a href='#section3' className='text-blue-400 font-bold hover:underline hover:text-blue-400 font-bold'>
  ...
  const content = (
    <section id="content" className="black sm:mb-20 mb-4 sm:px-4 sm:px-3">
      ...
      <section id="section1">
        <h1 className="font-bold text-blue-600 mb-0 mt-0 sm:mt-5 sm:mb-0 w-72 sm:w-10/12  lg:text-2xl md:text-2xl text-sm">
      ...
      <section className='my-5' id="section2 mt-10">
        <p className='  text-sm mb-3 lg:w-10/12 md:w-96 w-72 articles text-justify'>I'm super excited to be able to share this with you.</p>
        <p className='  text-sm mb-3 lg:w-10/12 md:w-96 w-72 articles text-justify'>Before we get too busy, let's get some mental boost.</p>
        <p className=' text-sm mb-0 lg:w-10/12 md:w-96 w-72 text-justify articles '>This write-up is divided into five sections for easy consumption. You can take a break after
          each section. </p>

        <p className=' text-sm articles mt-4 sm:mb-7 mb-5 lg:w-10/12 md:w-96 w-72 text-justify'>I know this writeup will take my time, but in times like this, humanity comes first. So test your
          resilience and discipline also by determining to get to the end.</p>
        <p className=' text-sm sm:mb-10 mb-5 lg:w-10/12 md:w-96 w-80 articles'>Let's dive right into it
        </p>
      </section>

      <section id="section2 mb-30">
        <h2
          id="section1"
          className="text-2xl sm:text-3xl font-extrabold text-blue-600 mt-4 mb-4 relative"
        >
          SECTION 1
          <span className="text-gray-500 font-medium text-sm ml-2">(SPIRITUALITY)</span>
          <div className="absolute mt-1 bg-blue-500 h-1 w-14 rounded-lg"></div>
        </h2>

        <img src={spiritual} alt="imagesave" className=' my-5 heights w-72 sm:w-10/12 rounded ' />
        <p className='mt-3 mb-4 lg:w-10/12 md:w-96 articles w-72 text-sm text-justify'>It’s important to begin by highlighting that Islam encourages planning and foresight. In fact, you
        ...
        <h1 className=' mb-5 lg:w-10/12 md:w-96 w-72 text-justify  articles'>Over the past few months, our brothers and sisters have celebrated numerous achievements, including earning degrees and certifications, welcoming new children, entering into nikaah,
          receiving promotions, launching new businesses, expanding existing ventures, and much more.
          Baarokallahu feekum.

        </h1>
        <div className=''>
          <p className=' mb-5 text-justify articles '>Let's do more, we need all of them.
          </p>
          <p className=' mb-5 lg:w-10/12 md:w-96 w-72 articles text-justify'>
          ...
          <section>
            <h2
              id="section1"
              className="text-2xl sm:text-3xl font-extrabold mt-4 text-blue-600 mb-4 relative"
            >
              SECTION 2
              <span className="text-gray-500 font-medium text-sm ml-2">(GENERAL LIFE HACKS)</span>
              <div className="absolute mt-1 bg-blue-500 h-1 w-14 rounded-lg"></div>
            </h2>

            <img src={life} alt="imagesave" className=' my-5 heights w-72 sm:w-10/12 rounded ' />
            <p className='  text-sm mb-3 lg:w-10/12 md:w-96 w-72 articles text-justify'>
      ...
      <section id="section3">
        <h2
          id="section1"
          className="text-2xl sm:text-3xl font-extrabold text-blue-600 mb-4 relative"
        >
          SECTION 3
          <span className="text-gray-500 font-medium text-sm ml-2 mt-4">(FINANCIAL FREEDOM)</span>
          <div className="absolute mt-1 bg-blue-500 h-1 w-14 rounded-lg"></div>
        </h2>
        ...
        <p className='  text-sm mb-3 lg:w-10/12 md:w-96 w-72 articles text-justify sm:translate-x-4'>
      ...
      <section id="section4">
        ...
        >
          SECTION 4
          <span className="text-gray-500 font-medium text-sm ml-2">(STAYING HEALTHY)</span>
          <div className="absolute mt-1 bg-blue-500 h-1 w-14 rounded-lg"></div>
        </h2>
      ...
      <section id="section5">
        <h2
          id="section1"
          className="text-2xl sm:text-3xl mt-4 font-extrabold text-blue-600 mb-4 relative"
        >
          SECTION 5
          <span className="text-gray-500 font-medium text-sm ml-2">(FAMILY AND FRIENDS)</span>
          <div className="absolute mt-1 bg-blue-500 h-1 w-14 rounded-lg"></div>
        </h2>
      ...
      <section id="section6">
        <h2
          id="section6"
          className="text-2xl sm:text-3xl font-extrabold text-blue-600 mb-6 sm:mt-10 text-left relative"
        >
          CONCLUSION
          <div className="absolute mt-1 bg-blue-500 h-1 w-14 rounded-lg"></div>
        </h2>
        ...
        <button
          onClick={downloadPDF}
          className="bg-blue-500 gap-2 flex mb-2 block sm:hidden justify-start align-start text-white px-4 py-2 rounded mt-4 hover:bg-blue-700 transition mb-12"
        >
