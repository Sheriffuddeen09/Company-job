...
function Article2023(){
    ...
    const content = (
        <section className="text-white sm:mb-20 mb-5 sm:px-4 sm:px-3 ">
            ...
            <p className='text-sm text-white mt-3 sm:mb-10 mb-5 text-center'>Complete video</p>
            </section>
            <section>
            ...
            <p className='text-white mb-5 lg:w-10/12 md:w-96 w-72 text-justify'>However, migrating from being an employee to an employer should be gradual. I will advise you to gather enough money, education (financial education), experience, materials and confidence needed before you switch. It's also true that not all businesses need a lot of experience and money to start, you will learn and acquire more funds as you progress. Don't allow anything to hold you back if you're convinced and determined. Your readiness, having a sound business idea and proper planning, all crowned with prayer are more important than the capital for a business to be successful. Even having a sound idea with proper planning will attract the right funding.
            </p>
            <p className='text-white mb-2 lg:w-10/12 md:w-96 w-72 text-sm'>
            1. It's about you identifying a problem, finding a solution, money will always follow - Kayode Quadri.
            
            </p>
            <p className='text-white mb-2 lg:w-10/12 md:w-96 w-72 text-sm text-justify'>
            2. Also have a cushion . That is something to fall *forward to (don't fall back, but fall forward). Having a good reserve will give you the confidence when starting your new adventure - the entrepreneurship journey. Expect the ups and downs. You should know the level of your failure tolerance and outline your recovery plans.
             ...
             <p className='text-white -mb-3 lg:w-10/12 md:w-96 w-72 text-sm text-justify'>
...
<div className='lg:translate-x-12 md:translate-x-4'>
    ...
    const sidecontent = (
        <section className='sm:block hidden lg:mt-40 md:mt-20'>
            <div className='bg-white p-4 lg:w-64 w-64 rounded'>
