...
<div className='gap-2 flex-col flex bg-black w-64 fixed right-0 p-4 text-black h-full text-end'>
...
<Link to={'/'} className={`text-white text-sm  rounded-xl p-2 transition-all duration-500 ease-in-out hover:bg-[#626267] cursor-pointer `}>MISSION
                <div className={`transition-all duration-500 ease-in-out hover:bg-[#626267] ${homepage === '/' ? 'home' : 'none'}`}> </div>
                </Link>
                <hr className={` h-0.5 ${homepage === '/' ? 'hidden' : 'block'}`}/>
                <Link to={'/launch'} className="text-white text-sm text-white text-sm  rounded-xl p-2 transition-all duration-500 ease-in-out hover:bg-[#626267] cursor-pointer">LAUNCHES
                <div className={`${homepage === '/launch' ? 'home' : 'none'}`}> </div>
                </Link>
                <hr className={` h-0.5 ${homepage === '/launch' ? 'hidden' : 'block'}`}/>
                <Link to={'/career'} className="text-white text-sm text-white text-sm  rounded-xl p-2 transition-all duration-500 ease-in-out hover:bg-[#626267] cursor-pointer">CAREERS
                <div className={`${homepage === '/career' ? 'home' : 'none'}`}> </div>
                </Link>
                <hr className={` h-0.5 ${homepage === '/career' ? 'hidden' : 'block'}`}/>
                <Link to={'/update'} className="text-white text-sm text-white text-sm  rounded-xl p-2 transition-all duration-500 ease-in-out hover:bg-[#626267] cursor-pointer">UPDATES
                <div className={`${homepage === '/update' ? 'home' : 'none'}`}> </div>
                </Link>
                <hr className={` h-0.5 ${homepage === '/update' ? 'hidden' : 'block'}`}/>
                <Link to={'/shop'} className="text-white text-sm text-white text-sm  rounded-xl p-2 transition-all duration-500 ease-in-out hover:bg-[#626267] cursor-pointer">SHOP
                <div className={`${homepage === '/shop' ? 'home' : 'none'}`}> </div>
                </Link>
                <hr className={` h-0.5 ${homepage === '/shop' ? 'hidden' : 'block'}`}/>
                <Link to={'/log'} className="text-white text-sm text-white text-sm  rounded-xl p-2 transition-all duration-500 ease-in-out hover:bg-[#626267] cursor-pointer">LOGISTICS
                <div className={`${homepage === '/log' ? 'home' : 'none'}`}> </div>
                </Link>
                <hr className={` h-0.5 ${homepage === '/log' ? 'hidden' : 'block'}`}/>
                ...
                <hr className={` h-0.5 ${homepage === '/tech' ? 'hidden' : 'block'}`}/>
