...
function Careers (){
    ...
    const job = (
        ...
        <p className="text-sm sm:w-96 w-64 text-justify">If you are a professional rider with extensive knowledge of lagos roads (both Mainland and Island) we invite you to apply. Please send your CV to: <a href="mailto:logistics.recruitment@ecoreme.com" className="mt-1 text-blue-300 font-bold  abouthover text-sm">logistics.recruitment@ecoreme.com</a></p>
        </div>
