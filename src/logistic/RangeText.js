...
function RangeText (){
    ...
    const content = (
        ...
        <div className="bg-white rounded-xl sm:px-12 pt-7 px-8"   data-aos="zoom-in">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25 21 12m0 0-3.75 3.75M21 12H3" />
                ...
                <button className="flex items-center sm:w-72 -my-14 px-2 py-2 rounded-xl text-white text-sm mx-auto inline-flex gap-1 sm:gap-2 sm:-translate-x-4 sm:translate-x-0 mt-10 mb-20 justify-center bg-green-600 rounded" style={{
                    fontSize:"10px"
                }}>
                    
                    Click to Order For Pickup/Delivery<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4 mt-2">
  <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25 21 12m0 0-3.75 3.75M21 12H3" />
</svg>
